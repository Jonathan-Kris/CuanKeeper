...
public class ActivityLoginGoogle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        authStateListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    Intent intent = new Intent(ActivityLoginGoogle.this, ActivityMain.class);
        ...
        Button LoginWithEmailBtn = findViewById(R.id.button_login);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(ActivityLoginGoogle.this, "Failed", Toast.LENGTH_SHORT).show();
                            loader.dismiss();
                        }
                    }
                });
    ...
    private void updateUI(Object o) {
        ...
        GoogleSignInAccount googleSignInAccount = GoogleSignIn.getLastSignedInAccount(ActivityLoginGoogle.this);
        if (googleSignInAccount != null) {
            ...
            usersRef.child(id).updateChildren(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if (task.isSuccessful()) {
                        Toast.makeText(ActivityLoginGoogle.this, "Successful", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(ActivityLoginGoogle.this, ActivityMain.class);
                        startActivity(intent);
                        finish();
                    } else {
                        Toast.makeText(ActivityLoginGoogle.this, "Failed to save data " + task.getException().toString(), Toast.LENGTH_SHORT).show();
                    }
                }
            });
