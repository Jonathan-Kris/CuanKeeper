...
public class ActivityLogin extends AppCompatActivity {
    ...
    private void updateUI(Object o) {
        ...
        GoogleSignInAccount googleSignInAccount = GoogleSignIn.getLastSignedInAccount(ActivityLogin.this);
        if (googleSignInAccount != null) {
            ...
            usersRef.child(id).updateChildren(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if (task.isSuccessful()) {
                        Toast.makeText(ActivityLogin.this, "Successful", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(ActivityLogin.this, ActivityMain.class);
                        startActivity(intent);
                        finish();
                    } else {
                        Toast.makeText(ActivityLogin.this, "Failed to save data " + task.getException().toString(), Toast.LENGTH_SHORT).show();
                    }
                }
            });
